...
3. **Investigate and implement** only that issue. Use CodeGraph when the injected CodeGraph contract requires it. Run the issue's criterion checks and `docs/testing.md`. Fix failures. File leftover work as new beads; do not keep it on this id.
